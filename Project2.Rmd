...
DebtData <- Project2 %>% 
  ...
  mutate_at(c("GRAD_DEBT_MDN","MD_EARN_WNE_P10","LO_INC_DEBT_MDN","MD_INC_DEBT_MDN","HI_INC_DEBT_MDN") , as.character) %>%
  mutate_at(c("GRAD_DEBT_MDN","MD_EARN_WNE_P10","LO_INC_DEBT_MDN","MD_INC_DEBT_MDN","HI_INC_DEBT_MDN") , as.numeric) %>%
  rename(
  ...
  pivot_longer(cols = c(Low_Income,Middle_Income,High_Income), 
                                      names_to = "Income_Level", values_to="Median Debt")
